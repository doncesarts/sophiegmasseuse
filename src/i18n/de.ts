...
const de: Translations = {
  ...
  about: {
    ...
    qualifications: [
      "Klassische Massage @ Klubschule Migros, Schweiz",
      "VTCT Skills Level 3 Zertifikat in Schwedischer Massage @ BISA, Bali",
      "CIBTAC-akkreditierte Balinesische Massage @ BISA, Bali",
    ],
